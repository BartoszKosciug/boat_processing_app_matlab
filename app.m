...
% Last Modified by GUIDE v2.5 27-Dec-2017 22:03:32
...
handles.img_bin = translation(handles.img_bin);
axes(handles.axes2);
imshow(handles.img_bin,[]);
guidata(hObject, handles);


%licze k¹t obrotu metod¹ macierzy kowariancji 
function pushbutton12_Callback(hObject, eventdata, handles)
[handles.obrotKow,~] = orientation(handles.img_bin);
msgbox(['Wyliczona wartoœæ k¹ta obrotu metod¹ macierzy kowariancji jest równa:' ,num2str(handles.obrotKow)]);
guidata(hObject, handles);


%licze k¹t obrotu metod¹ momentów 
function pushbutton13_Callback(hObject, eventdata, handles)
[~, handles.obrotMom] = orientation(handles.img_bin);
msgbox(['Wyliczona wartoœæ k¹ta obrotu metod¹ momentów jest równa:' ,num2str(handles.obrotMom)]);
guidata(hObject, handles);
